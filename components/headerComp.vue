          ...
          <ul id="main-nav" class="navbar-nav mr-auto lg:flex lg:flex-row">
            <template>
              <li v-for="item in menuItems" :key="item.id">
                <NuxtLink :to=item.link :class=linkStyles >{{ item.title }}</NuxtLink>
              </li>
            </template>
          </ul>
        </div>
        <searchComp />
        <div class="flex items-center absolute -mt-16 sm:relative sm:mt-0">
          <button
            class="navbar-toggler border-0 py-3 lg:hidden leading-none text-xl bg-transparent text-black hover:text-green-600 focus:text-green-600 transition-shadow duration-150 ease-in-out"
            type="button"
...
export default {
  data() {
    return {
      menuItems: [
        { link: "#link1", title: "Foundations" },
        { link: "#link2", title: "Content" },
        { link: "#link3", title: "Design" },
        { link: "#link4", title: "Tokens" },
        { link: "#link5", title: "Components" },
        { link: "#link6", title: "Patterns" },
        { link: "/planets", title: "Planets" },
        { link: "/posts", title: "Posts" }
      ],
      linkStyles: ['nav-link block pr-3 lg:px-4 py-2 text-black hover:text-blue-600 transition duration-150 ease-in-out'],
    };
  },
};
</script>
